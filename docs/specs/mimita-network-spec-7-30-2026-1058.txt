...
This
* https://docs.google.com/document/d/1uTxOkciwKHtSzBm4rKxxMqMshNGttK9TOk8ju3uBu-E/edit?tab=t.luksvv2s1r88 
________________
...
*   "max_players": 16,
*   "public": true,
*   "coordinator_url": "https://api.mimita.fun",
*   "require_relay": false
* }
* * Add:
...
* * coordinator_url=https://community.example
...
Chainofjudgement… 2
Aabbtest… 3
Writing server_map 2 means “I request this server’s map be changed to Chainofjudgement”
...
Like if u see a huge sphere that sas “insufficient_ammo” whevner u shoot, its a lot easier to debug

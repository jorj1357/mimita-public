...
bool GuiLayout::load(const std::string& filePath, const std::string& sectionId)
{
    ...
    try {
        ...
        std::function<GuiElement(const json&)> parseElement = [&](const json& elem) -> GuiElement {
            ...
            e.maxDistance = elem.value("maxDistance", 0.0f);
            e.fadeStartDistance = elem.value("fadeStartDistance", 0.0f);
            e.fadeEndDistance = elem.value("fadeEndDistance", 0.0f);
            e.fadeTicks = elem.value("fadeTicks", 0);
            e.timeoutTicks = elem.value("timeoutTicks", 0);
            e.blinkTicks = elem.value("blinkTicks", 0);
            e.heartbeatTicks = elem.value("heartbeatTicks", 0);
            e.heightOffset = elem.value("heightOffset", 0.0f);
            e.nameFontSize = elem.value("nameFontSize", 0.0f);
            e.lineHeight = elem.value("lineHeight", 0.0f);
            e.maxWidth = elem.value("maxWidth", 0.0f);
            e.maxItems = elem.value("maxItems", 0);
            e.durationBaseTicks = elem.value("durationBaseTicks", 0);
            e.durationPerCharTicks = elem.value("durationPerCharTicks", 0);
            e.showAboveHead = elem.value("showAboveHead", false);
            e.showInChat = elem.value("showInChat", false);
            e.showSelfAboveHead = elem.value("showSelfAboveHead", false);
            e.showSelfInChat = elem.value("showSelfInChat", false);
...
bool GuiLayout::save(const std::string& filePath) const
{
    ...
    for (const std::string& id : ids) {
        ...
        if (e.maxDistance != 0.0f) obj["maxDistance"] = e.maxDistance;
        if (e.fadeStartDistance != 0.0f) obj["fadeStartDistance"] = e.fadeStartDistance;
        if (e.fadeEndDistance != 0.0f) obj["fadeEndDistance"] = e.fadeEndDistance;
        if (e.fadeTicks != 0) obj["fadeTicks"] = e.fadeTicks;
        if (e.timeoutTicks != 0) obj["timeoutTicks"] = e.timeoutTicks;
        if (e.blinkTicks != 0) obj["blinkTicks"] = e.blinkTicks;
        if (e.heartbeatTicks != 0) obj["heartbeatTicks"] = e.heartbeatTicks;
        if (e.heightOffset != 0.0f) obj["heightOffset"] = e.heightOffset;
        if (e.nameFontSize != 0.0f) obj["nameFontSize"] = e.nameFontSize;
        if (e.lineHeight != 0.0f) obj["lineHeight"] = e.lineHeight;
        if (e.maxWidth != 0.0f) obj["maxWidth"] = e.maxWidth;
        if (e.maxItems != 0) obj["maxItems"] = e.maxItems;
        if (e.durationBaseTicks != 0) obj["durationBaseTicks"] = e.durationBaseTicks;
        if (e.durationPerCharTicks != 0) obj["durationPerCharTicks"] = e.durationPerCharTicks;
        if (e.showAboveHead) obj["showAboveHead"] = e.showAboveHead;
        if (e.showInChat) obj["showInChat"] = e.showInChat;
        if (e.showSelfAboveHead) obj["showSelfAboveHead"] = e.showSelfAboveHead;
        if (e.showSelfInChat) obj["showSelfInChat"] = e.showSelfInChat;

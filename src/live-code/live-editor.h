...
* functions (spatial query, inspection snapshot, UI draw primitives) and the
* per-tick / per-frame invocation. All selection/inspection/layout policy lives
* in the hot module.
...
// Per fixed simulation tick. Returns true when the hot module handled it.

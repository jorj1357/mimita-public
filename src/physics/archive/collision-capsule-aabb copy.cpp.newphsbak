...
//     float t = 0.0f;
//     if (segLen2 > EPS) {
//         glm::vec3 c = clampPointAABB(cap.a, boxCenter, half);
//         t = glm::dot(c - cap.a, segDir) / segLen2;
//         t = glm::clamp(t, 0.0f, 1.0f);
//     }

//     glm::vec3 bestCap = cap.a + segDir * t;
//     glm::vec3 bestBox = clampPointAABB(bestCap, boxCenter, half);
...
//         glm::vec3 n = (dist > EPS) ? delta / dist : glm::vec3(0,0,1);

//         if (outNormalLocal) *outNormalLocal = n;

//         float pen = cap.r - dist;

//         // JUST PUSH OUT. NOTHING ELSE.
//         glm::vec3 out = move + n * pen;

//         // everything you touch is ground (for now)
//         onGround = true;

//         return out;
//     }

//     if (outNormalLocal) *outNormalLocal = glm::vec3(0);
//     return move;
// }

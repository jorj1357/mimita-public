...
inline float GROUND_FRICTION_AMOUNT = 4.0f;
inline float GROUND_ACCELERATE = 8.0f;
inline float AIR_FRICTION_AMOUNT = 0.0f;
inline float AIR_ACCEL_AMOUNT = 6.0f;
inline float AIR_SPEED_CAP = 35.0f;
